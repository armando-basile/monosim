...
public class clsNewItemDlg
{
	...
	[Glade.Widget] Gtk.Label            lblPhone;
	...
	public clsNewItemDlg(Window w, DialogFlags df, ref string[] dataContact, ref clsLanguageHelper myTranslator)
	{
		...
		this.NewItemDlg.Title = myTranslator.readTranslatedString(119) ;
		
		lblInfo.Markup = myTranslator.readTranslatedString(120) ;
		lblDesc.Markup = myTranslator.readTranslatedString(121) ;
		lblPhone.Markup = myTranslator.readTranslatedString(122) ;
